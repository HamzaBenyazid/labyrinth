...
//Cette fonction retourne une matrice de caractère qu'on va afficher si il y a un mur on met '#' sinon un espace
...
//cette fonction afficher le labyrinthe dans le console
